...
export function Page3({ go, onBack }) {
  ...
  const VideoBlock = () => {
    ...
    // Poster state — clean dark video player (NOT a portrait): play button + runtime.
    return (
      <div onClick={() => CEO_VIDEO_URL && setPlaying(true)} style={{
        ...
        <div style={{ width: 56, height: 56, borderRadius: "50%",
          ...
          color: "#1A1206", fontSize: 22, boxShadow: "0 4px 20px rgba(0,0,0,0.5)" }}>▶</div>
  ...
  return (
    <Shell step={3} onBack={onBack}>
      <div style={{ position: "relative" }}>
        {/* Subtle live-music imagery in the background, dimmed behind a dark scrim */}
        <div aria-hidden="true" style={{
          position: "absolute", inset: "-16px -16px 0", zIndex: 0, pointerEvents: "none",
          borderRadius: 16, overflow: "hidden",
          background: "radial-gradient(120% 80% at 50% 0%, rgba(237,185,1,0.10) 0%, rgba(0,201,221,0.06) 40%, #000000 78%)",
        }}>
          <div style={{
        ...
        <Kicker>The Circle 35 Promo Video</Kicker>
        ...
        <div style={{ display: "flex", gap: 16, alignItems: "stretch", marginTop: 20 }}>
          ...
          <div style={{ flex: 1 }}>
            <p style={{ color: C.textDim, fontSize: 13.5, lineHeight: 1.6, fontStyle: "italic",
              margin: 0 }}>
              Thank you for your interest in Music Habitat and The Circle 35. We're building
              the operating system that will power the future of live music — for the artists,
              venues, and fans worldwide.
            </p>
            <p style={{ color: C.textDim, fontSize: 13.5, lineHeight: 1.6, fontStyle: "italic",
              margin: "12px 0 0" }}>
              As a member of The Circle 35, you'll be part of the origin story. I look forward
              to welcoming you into the circle.
            </p>
            <BrandonSignature />
          </div>
        </div>
        ...
        <div style={{ marginTop: 24 }}>
          <Btn variant="amber" onClick={() => go("page4")}>Continue</Btn>
        </div>
      </div>
      </div>
    </Shell>
...
// =============================================================================
// PAGE 4 — The Circle 35 · Founding Investor Program (target raise = $250,000)
// =============================================================================
